        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute right-0 mt-2 w-40 bg-dark-800 border border-dark-700 rounded-xl shadow-xl z-50"
            >
              <div className="py-2 max-h-72 overflow-y-auto">
                {supported.map((code) => (
                  ...
                  >
                    ...
                    {currencyCode === code && <Check size={16} className="text-primary-500" />}
                  </button>
                ))}
              </div>
            </motion.div>
