...
export const receiptAPI = {
  ...
  generateReceipt: (transactionId: string) => api.post(`/receipts/generate/${transactionId}`),
  autoGenerateReceipts: () => api.post('/receipts/auto-generate'),
};
...
export const adminAPI = {
  ...
  getKycRequests: (params?: any) => api.get('/kyc/admin/requests', { params }),
  getKycDetails: (id: string) => api.get(`/kyc/admin/details/${id}`),
  reviewKyc: (id: string, data: any) => api.post(`/kyc/admin/review/${id}`, data),
  getDeposits: (params?: any) => api.get('/admin/deposits', { params }),
  updateDepositStatus: (id: string, data: any) => api.put(`/admin/deposits/${id}`, data),
  getWithdrawals: (params?: any) => api.get('/admin/withdrawals', { params }),
  updateWithdrawalStatus: (id: string, data: any) => api.put(`/admin/withdrawals/${id}`, data),
  getInvestments: (params?: any) => api.get('/admin/investments', { params }),
  updateInvestmentStatus: (id: string, data: any) => api.put(`/admin/investments/${id}`, data),
  ...
  updateNotification: (id: string, data: any) => api.put(`/admin/notifications/${id}`, data),
