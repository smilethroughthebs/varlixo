  ...
  imports: [
    ...
    MongooseModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => ({
        ...
        serverSelectionTimeoutMS: configService.get<number>('database.serverSelectionTimeoutMS') || 5000,
        connectTimeoutMS: configService.get<number>('database.connectionTimeoutMS') || 10000,
        socketTimeoutMS: configService.get<number>('database.socketTimeoutMS') || 45000,
        maxPoolSize: configService.get<number>('database.maxPoolSize') || 10,
        minPoolSize: configService.get<number>('database.minPoolSize') || 2,
        maxIdleTimeMS: configService.get<number>('database.maxIdleTimeMS') || 30000,
        retryWrites: true,
        w: 'majority',
      }),
    }),
